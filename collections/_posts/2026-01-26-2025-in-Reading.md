...
* <cite>Academic Exercises</cite> by K.J. Parker: This is a collection of short fiction (including a couple novellas) set in a fantasy world with lots of western Europe academic energy. Parker does a great job writing unreliable narrators with strong voices. I thought <a href="{{ site.baseurl }}{% post_url 2016-09-06-Purple-and-Black %}"><cite>Purple and Black</cite></a> was the gem in the collection, so I'd say start with that, and if you like it, take comfort in knowing there's more in store.
